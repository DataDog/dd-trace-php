...
TEA_TEST_CASE("symbol/lookup/constant", "global, exists", {
    zai_string_view name = ZAI_STRL("PHP_VERSION");
    zai_string_view mixed = ZAI_STRL("Php_Version");
...
TEA_TEST_CASE("symbol/lookup/constant", "global, does not exist", {
    zai_string_view name = ZAI_STRL("NO_SUCH_CONSTANT");
    zai_string_view mixed = ZAI_STRL("No_Such_Constant");
...
TEA_TEST_CASE_WITH_STUB("symbol/lookup/constant", "ns, exists", "./stubs/lookup/constant/Stub.php", {
    ...
    zai_string_view name = ZAI_STRL("DD_TRACE_TESTING");
...
TEA_TEST_CASE_WITH_STUB("symbol/lookup/constant", "ns, does not exists", "./stubs/lookup/constant/Stub.php", {
    zai_string_view ns   = ZAI_STRL("\\DDTraceTesting");
    zai_string_view name = ZAI_STRL("DD_TEST_CONSTANT_DOES_NOT_EXIST");
...
TEA_TEST_CASE_WITH_STUB("symbol/lookup/constant", "class, does not exist", "./stubs/lookup/constant/Stub.php", {
    zai_string_view ns   = ZAI_STRL("\\DDTraceTesting");
    zai_string_view cn   = ZAI_STRL("Stub");
    zai_string_view name = ZAI_STRL("DD_TRACE_TESTING_DOES_NOT_EXIST");
