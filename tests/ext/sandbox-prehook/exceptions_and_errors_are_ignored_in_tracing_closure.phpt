...
?>
--EXPECTF--
[ddtrace] [warning] [%d] %s in ddtrace's closure defined at %s:%d for Test::testFoo(): Undefined variable%sthis_normally_raises_an_%s
[ddtrace] [warning] [%d] Exception thrown in ddtrace's closure defined at %s:%d for mt_srand(): This should be ignored in %s on line %d
[ddtrace] [warning] [%d] Error raised in ddtrace's closure defined at %s:%d for mt_rand(): htmlentities(): Only basic entities substitution is supported for multi-byte encodings other than UTF-8; functionality is equivalent to htmlspecialchars in %s on line %d
Test::testFoo() fav num: %d
TestFoo
MTRand
MTSeed
