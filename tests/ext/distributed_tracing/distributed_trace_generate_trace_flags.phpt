...
DDTrace\consume_distributed_tracing_headers([
    'traceparent' => '00-11111111111111112222222222222222-3333333333333333-02',
]);
$root = DDTrace\start_trace_span();
echo 'propagated reject: ', generated_trace_flags(), PHP_EOL;
$root->samplingPriority = DD_TRACE_PRIORITY_SAMPLING_USER_KEEP;
echo 'propagated keep: ', generated_trace_flags(), PHP_EOL;
DDTrace\close_span();
?>
--EXPECT--
local keep: 03
