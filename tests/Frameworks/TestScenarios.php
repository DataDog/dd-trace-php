...
class TestScenarios
{
    public static function all()
    {
        return [
            ...
            GetSpec::create('A GET request ended in http_status_code(200)', '/http_response_code_success'),
            GetSpec::create('A GET request ended in http_status_code(500)', '/http_response_code_failure'),
        ];
    }
}
