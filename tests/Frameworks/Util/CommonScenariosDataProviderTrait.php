...
trait CommonScenariosDataProviderTrait
{
    ...
    public function buildDataProvider($definedExpectations)
    {
        ...
        if ($unexpectedExpectations) {
            throw new PHPUnit_Framework_ExpectationFailedException('Found the following expectations not having any request defined: '
        ...
        if ($unexpectedRequest) {
            throw new PHPUnit_Framework_ExpectationFailedException('Found the following scenarios not having any expectation defined: '
