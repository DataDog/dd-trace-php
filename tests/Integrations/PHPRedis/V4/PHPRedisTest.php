    ...
    public function testSelect()
    {
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.select"
            )->withExactTags(['db.index' => '1', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
    }
    ...
    public function testStringCommandsSet($method, $args, $expected, $rawCommand, $initial = null)
    {
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.$method"
            )->withExactTags(['redis.raw_command' => $rawCommand, Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
    ...
    public function testMSet()
    {
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.mSet"
            )->withExactTags(['redis.raw_command' => 'mSet k1 v1 k2 v2', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
    ...
    public function testMSetNx()
    {
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.mSetNx"
            )->withExactTags(['redis.raw_command' => 'mSetNx k1 v1 k2 v2', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
    ...
    public function testRawCommand()
    {
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.rawCommand"
            )->withExactTags(['redis.raw_command' => 'rawCommand set k1 v1', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
    ...
    public function testPublish()
    {
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.publish"
            )->withExactTags(['redis.raw_command' => 'publish ch1 hi', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
    }
    ...
    public function testTransactions()
    {
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.multi"
            )->withExactTags(['redis.raw_command' => 'multi', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
            SpanAssertion::build(
                "Redis.set",
                'phpredis',
                'redis',
                "Redis.set"
            )->withExactTags(['redis.raw_command' => 'set k1 v1', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
            SpanAssertion::build(
                "Redis.get",
                'phpredis',
                'redis',
                "Redis.get"
            )->withExactTags(['redis.raw_command' => 'get k1', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
            SpanAssertion::build(
                "Redis.exec",
                'phpredis',
                'redis',
                "Redis.exec"
            )->withExactTags(['redis.raw_command' => 'exec', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
    }
    ...
    public function testDumpRestore()
    {
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.dump"
            )->withExactTags(['redis.raw_command' => 'dump k1', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
            SpanAssertion::build(
                "Redis.restore",
                'phpredis',
                'redis',
    ...
    public function testMigrate()
    {
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.migrate"
            )->withExactTags(['redis.raw_command' => "migrate redis_integration 6380 k1 0 3600", Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.migrate"
            )->withExactTags(['redis.raw_command' => "migrate redis_integration 6380 k2 k3 0 3600", Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
    ...
    public function testMove()
    {
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.move"
            )->withExactTags(['redis.raw_command' => "move k1 1", Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
    ...
    public function testRenameKey()
    {
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.renameKey"
            )->withExactTags(['redis.raw_command' => "renameKey k1 k2", Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
    ...
    public function testStreamsFunctions()
    {
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.xAdd"
            )->withExactTags(['redis.raw_command' => 'xAdd s1 123-456 k1 v1', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.xGroup"
            )->withExactTags(['redis.raw_command' => 'xGroup CREATE s1 group1 0', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.xInfo"
            )->withExactTags(['redis.raw_command' => 'xInfo GROUPS s1', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.xLen"
            )->withExactTags(['redis.raw_command' => 'xLen s1', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.xPending"
            )->withExactTags(['redis.raw_command' => 'xPending s1 group1', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.xRange"
            )->withExactTags(['redis.raw_command' => 'xRange s1 - +', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.xRevRange"
            )->withExactTags(['redis.raw_command' => 'xRevRange s1 + -', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.xRead"
            )->withExactTags(['redis.raw_command' => 'xRead s1 $', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.xReadGroup"
            )->withExactTags(['redis.raw_command' => 'xReadGroup group1 consumer1 s1 >', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.xAck"
            )->withExactTags(['redis.raw_command' => 'xAck s1 group1 s1 123-456', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.xClaim"
            )->withExactTags(['redis.raw_command' => 'xClaim s1 group1 consumer1 0 s1 123-456', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.xDel"
            )->withExactTags(['redis.raw_command' => 'xDel s1 123-456', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
        ...
        $this->assertFlameGraph($traces, [
            SpanAssertion::build(
                ...
                'redis',
                "Redis.xTrim"
            )->withExactTags(['redis.raw_command' => 'xTrim s1 0', Tag::SPAN_KIND => 'client', Tag::COMPONENT => 'phpredis',]),
        ]);
    }
