...
namespace DDTrace\Tests\Integrations\OpenSwoole;
...
class CommonScenariosTest extends WebFrameworkTestCase
{
    ...
    {
        return __DIR__ . '/../../Frameworks/OpenSwoole/index.php';
    }
    ...
    protected static function getEnvs()
    {
        return array_merge(parent::getEnvs(), [
            'DD_SERVICE' => 'openopenswoole_test_app',
