...
final class EnvVariableRegistryTest extends BaseTestCase
{
    ...
    {
        parent::ddSetUp();
        self::putenv('DD_SOME_TEST_PARAMETER');
        self::putenv('DD_CUSTOM_PREFIX_SOME_TEST_PARAMETER');
    }

    public function testPrefixDefaultToDD()
    {
        self::putenv('DD_SOME_TEST_PARAMETER=bar');
    ...
    {
        self::putenv('DD_CUSTOM_PREFIX_SOME_TEST_PARAMETER=bar');
    ...
    {
        $registry = new EnvVariableRegistry();
        self::putenv('DD_SOME_TEST_PARAMETER=tRuE   ');
    ...
    {
        $registry = new EnvVariableRegistry();
        self::putenv('DD_SOME_TEST_PARAMETER=1   ');
        $this->assertTrue($registry->boolValue('some.test.parameter', false));
    }
    ...
    {
        $registry = new EnvVariableRegistry();
        self::putenv('DD_SOME_TEST_PARAMETER=fAlSe   ');
    ...
    {
        $registry = new EnvVariableRegistry();
        self::putenv('DD_SOME_TEST_PARAMETER=0   ');
        $this->assertFalse($registry->boolValue('some.test.parameter', true));
    }
    ...
    {
        $registry = new EnvVariableRegistry();
        self::putenv('DD_SOME_TEST_PARAMETER=0.7   ');
    ...
    {
        $registry = new EnvVariableRegistry();
        self::putenv('DD_SOME_TEST_PARAMETER=10000   ');
    ...
    {
        $registry = new EnvVariableRegistry();
        self::putenv('DD_SOME_TEST_PARAMETER=value1,value2');
    ...
    public function testAssociativeStringArrayNotPersistingDefaultValue()
    {
        ...
        self::putenv('DD_SOME_TEST_PARAMETER=key:value');
    ...
    {
        if (null !== $env) {
            self::putenv('DD_SOME_TEST_PARAMETER=' . $env);
        }
        $registry = new EnvVariableRegistry();
