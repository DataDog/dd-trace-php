...
class AutoInstrumentationTest extends BaseTestCase
{
    ...
    public function autoInstrumentationScenarios()
    {
        ...
        return [
            ...
            'composer_without_ddtrace_dependency'
            ...
            // version.
            'composer_with_ddtrace_dependency'
            ...
            'autoloader_includes_even_non_existing'
