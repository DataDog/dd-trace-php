...
impl SampleTypeFilter {
    pub fn new(system_settings: &SystemSettings) -> Self {
        ...
        static SAMPLE_TYPES: &[ValueType; MAX_SAMPLE_TYPES] = &[
            ...
            ValueType::new("socket-io-read-time", "nanoseconds"),
            ValueType::new("socket-io-write-time", "nanoseconds"),
            ValueType::new("file-io-read-time", "nanoseconds"),
            ValueType::new("file-io-write-time", "nanoseconds"),
            ValueType::new("socket-io-read-size", "bytes"),
            ValueType::new("socket-io-write-size", "bytes"),
    ...
    pub fn filter(&self, sample_values: SampleValues) -> Vec<i64> {
        ...
        let values: [i64; MAX_SAMPLE_TYPES] = [
            ...
            sample_values.socket_io_read_time,
            sample_values.socket_io_write_time,
            sample_values.file_io_read_time,
            sample_values.file_io_write_time,
            sample_values.socket_io_read_size,
            sample_values.socket_io_write_size,
