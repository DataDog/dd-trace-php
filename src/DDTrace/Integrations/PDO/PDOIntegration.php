...
class PDOIntegration
{
    ...
    public static function load()
    {
        ...
        dd_trace('PDO', '__construct', function () {
            ...
            $span->setTag(Tags\Ext::SERVICE_NAME, 'PDO');
            $span->setTag(Tags\Ext::RESOURCE_NAME, 'PDO.__construct');
        ...
        dd_trace('PDO', 'exec', function ($statement) {
            ...
            $span->setTag(Tags\Ext::SPAN_TYPE, Types\Ext::SQL);
            $span->setTag(Tags\Ext::SERVICE_NAME, 'PDO');
            $span->setTag(Tags\Ext::RESOURCE_NAME, $statement);
        ...
        dd_trace('PDO', 'query', function () {
            ...
            $span->setTag(Tags\Ext::SPAN_TYPE, Types\Ext::SQL);
            $span->setTag(Tags\Ext::SERVICE_NAME, 'PDO');
            $span->setTag(Tags\Ext::RESOURCE_NAME, $args[0]);
            PDOIntegration::setConnectionTags($this, $span);
        ...
        dd_trace('PDOStatement', 'execute', function () {
            ...
            $span->setTag(Tags\Ext::SPAN_TYPE, Types\Ext::SQL);
            $span->setTag(Tags\Ext::SERVICE_NAME, 'PDO');
            $span->setTag(Tags\Ext::RESOURCE_NAME, $this->queryString);
        ...
        foreach ($valStrings as $valString) {
            ...
            switch ($key) {
                ...
                case 'dbname':
                    ...
                    break;
                case 'host':
                    $tags[Tags\Ext::TARGET_HOST] = $value;
                    break;
                case 'port':
                    $tags[Tags\Ext::TARGET_PORT] = $value;
                    break;
            }
        }
