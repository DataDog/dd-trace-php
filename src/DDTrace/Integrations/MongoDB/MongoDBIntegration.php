...
class MongoDBIntegration extends Integration
{
        ...
        \DDTrace\hook_method(
            ...
            static function ($self, $_2, $args, $_4) {
                if (isset($args[0])) {
                    ...
                    \array_push($existingDeletes, self::serializeQuery($args[0]));
        ...
        \DDTrace\hook_method(
            ...
            static function ($self, $_2, $args, $_4) {
                if (isset($args[0])) {
                    ...
                    \array_push($existingUpdates, self::serializeQuery($args[0]));
    ...
    public static function serializeQuery($anythingQueryLike)
    {
        ...
        $normalizedQuery = self::normalizeQuery($anythingQueryLike);
