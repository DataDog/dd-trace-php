...
class CurlHandleAppSecContext
{
    ...
    private function handleRedirectInResponseHeaders(string $buffer, int &$lastReqPos) : void
    {
...
\DDTrace\trace_function('curl_exec', [
    'prehook' => static function (\DDTrace\SpanData $data, $args) {
        if (!\datadog\appsec\is_enabled()) {
            return;
        }
    ...
    'posthook' => static function (\DDTrace\SpanData $span, $args, $retval) {
        if (!\datadog\appsec\is_enabled()) {
            return;
        }
