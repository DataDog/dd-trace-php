...
void dd_mpack_write_nullable_cstr(mpack_writer_t *nonnull w,
        const char *nullable cstr);
void dd_mpack_write_nullable_str(mpack_writer_t *nonnull w,
        const char *nullable str, size_t len);

void dd_mpack_write_zstr(
    mpack_writer_t *nonnull w, const zend_string *nonnull zstr);
void dd_mpack_write_nullable_zstr(mpack_writer_t *nonnull w,
        const zend_string *nullable zstr);
