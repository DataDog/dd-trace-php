...
public:
    ...
    [[nodiscard]] virtual request recv(std::chrono::milliseconds initial_timeout) const = 0;
    [[nodiscard]] virtual bool send(const base_response &msg) const = 0;
};
...
public:
    ...
    [[nodiscard]] request recv(std::chrono::milliseconds initial_timeout) const override;
