                            ...
                            PHP_FE(dd_trace_set_trace_id, arginfo_dd_trace_set_trace_id)
                                PHP_FE(dd_trace_push_span_id, arginfo_dd_trace_push_span_id)
                                    PHP_FE(dd_trace_pop_span_id, NULL) PHP_FE(dd_trace_peek_span_id, NULL)
                                        PHP_FALIAS(dd_trace_generate_id, dd_trace_push_span_id, NULL) PHP_FE(
                                            dd_trace_closed_spans_count, NULL) PHP_FE(dd_trace_tracer_is_limited, NULL)
                                            PHP_FE(dd_trace_compile_time_microseconds,
                                                   arginfo_dd_trace_compile_time_microseconds) ZEND_FE_END};
