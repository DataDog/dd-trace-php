...
if test "$PHP_DD_LIBRARY_LOADER" != "no"; then
  ...
  PHP_NEW_EXTENSION(dd_library_loader, dd_library_loader.c dd_library_loader_module.c compat_php.c telemetry_reaper.c telemetry_reaper_asm.S, $ext_shared, , , , yes)
fi
