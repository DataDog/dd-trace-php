...
#if (defined(_CRASHTRACKING_COLLECTOR) && defined(_WIN32))
    HRESULT ddog_crasht_event_signature_callback(const void* _context,
...
#if (defined(_CRASHTRACKING_COLLECTOR) && defined(_WIN32))
    HRESULT ddog_crasht_debugger_launch_callback(const void* _context,
        const WER_RUNTIME_EXCEPTION_INFORMATION* _exception_information,
...
#if (defined(_CRASHTRACKING_COLLECTOR) && defined(_WIN32))
    HRESULT ddog_crasht_exception_event_callback(const void* context,
