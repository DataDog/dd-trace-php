 ...
 */
struct ddog_AttrBuilder *ddog_span_attr_open_list(ddog_TracerPayloadV1Builder *builder,
                                                  uintptr_t chunk,
                                                  uintptr_t span,
                                                  ddog_CharSlice key);
 ...
 */
struct ddog_AttrBuilder *ddog_span_attr_open_map(ddog_TracerPayloadV1Builder *builder,
                                                 uintptr_t chunk,
                                                 uintptr_t span,
                                                 ddog_CharSlice key);
