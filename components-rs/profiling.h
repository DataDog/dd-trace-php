 ...
 * No safety concerns.
 */
DDOG_CHECK_RETURN struct ddog_prof_CrashtrackerResult ddog_prof_Crashtracker_clear_span_ids(void);
 ...
 * No safety concerns.
 */
DDOG_CHECK_RETURN struct ddog_prof_CrashtrackerResult ddog_prof_Crashtracker_clear_trace_ids(void);
 ...
 */
DDOG_CHECK_RETURN
struct ddog_prof_CrashtrackerUsizeResult ddog_prof_Crashtracker_insert_trace_id(uint64_t id_high,
                                                                                uint64_t id_low);
 ...
 */
DDOG_CHECK_RETURN
struct ddog_prof_CrashtrackerUsizeResult ddog_prof_Crashtracker_insert_span_id(uint64_t id_high,
                                                                               uint64_t id_low);
 ...
 */
DDOG_CHECK_RETURN
struct ddog_prof_CrashtrackerResult ddog_prof_Crashtracker_remove_span_id(uint64_t id_high,
                                                                          uint64_t id_low,
                                                                          uintptr_t idx);
 ...
 */
DDOG_CHECK_RETURN
struct ddog_prof_CrashtrackerResult ddog_prof_Crashtracker_remove_trace_id(uint64_t id_high,
                                                                           uint64_t id_low,
                                                                           uintptr_t idx);
