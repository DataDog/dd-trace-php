...
PHP_ARG_ENABLE(ddtrace-auto-instrumentation-beta, whether to enable ddtrace beta auto instrumentation support,[  --enable-ddtrace-auto-instrumentation-beta   Enable ddtrace beta auto instrumentation], no, no)
