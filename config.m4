...
\$(builddir)/target/$ddtrace_cargodir/libddtrace_php.a: $((find "$ext_srcdir/components/rust" -name "*.rs"; find "$ext_srcdir/../../libdatadog" -name "*.rs"; find "$ext_srcdir/libdatadog" -name "*.rs") | xargs)
