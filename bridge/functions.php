...
function dd_wrap_autoloader()
{
    ...
    if (\function_exists('dd_trace_function')) {
        \dd_trace_function('spl_autoload_register', function (SpanData $span, $args) {
            if (sizeof($args) == 0) {
                return false;
            }
            list($loader) = $args;
            ...
            // otherwise we would trigger auto-instrumentation before the actual composer autoloader kicks in and we
            // would always use the DDTrace classes provided with the bundle even if the user declared
            // `datadog/dd-trace` in their composer.
