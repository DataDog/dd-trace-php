...
function dd_wrap_autoloader()
{
    ...
    dd_trace('spl_autoload_register', function () use (&$composerAutogeneratedClass) {
        ...
        // Is this really required? Composer registers its own autoloader pre-pending it to the list of already
        // registered auto-loaders. For this reason it would load the DDTrace namespace from its vendor folder
        // if available. On the other hand, returning above when we detect a `ComposerAutoloaderInit*` class is required
