...
return [
    ...
    __DIR__ . '/../src/api/Configuration/Registry.php',
    __DIR__ . '/../src/api/Configuration/EnvVariableRegistry.php',
    __DIR__ . '/../src/api/Configuration/AbstractConfiguration.php',
    __DIR__ . '/../src/api/Configuration.php',
