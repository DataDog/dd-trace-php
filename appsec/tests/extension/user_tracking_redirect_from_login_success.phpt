...
--EXPECTF--
Warning: datadog\appsec\track_user_login_success_event(): Datadog blocked the request and attempted a redirection to https://datadoghq.com - block_id:  in %s on line %d
