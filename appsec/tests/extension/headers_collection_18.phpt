--TEST--
All headers are collected when track_user_login_success_event_automated is triggered by automation and identification mode is set
--INI--
...
track_user_login_success_event_automated("login", "1234", []);
