--TEST--
All headers are collected when track_user_login_success_event_automated is triggered by automation and anonymization mode is set
--INI--
...
track_user_login_success_event_automated("login", "1234", ['email' => 'some@email.com']);
