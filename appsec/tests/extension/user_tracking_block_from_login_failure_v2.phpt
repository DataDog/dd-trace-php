--TEST--
Block from user v2 login failure event
--INI--
...
\DDTrace\ATO\V2\track_user_login_failure("some login", false,
[
    "value" => "something",
...
Warning: DDTrace\ATO\V2\track_user_login_failure(): Datadog blocked the request and presented a static error page in %s on line %d
