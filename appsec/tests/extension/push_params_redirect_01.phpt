...
--EXPECTF--
Warning: datadog\appsec\push_addresses(): Datadog blocked the request and attempted a redirection to https://datadoghq.com. No action required. Security Response ID:  in %s on line %d
