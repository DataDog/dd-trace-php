...
ARTIFACT_JOBS: dict[str, str] = {
    ...
    "extension-amd64-gnu-installers": "package extension (installers): [amd64, x86_64-unknown-linux-gnu]",
    "extension-aarch64-gnu-installers": "package extension (installers): [arm64, aarch64-unknown-linux-gnu]",
    "extension-amd64-bundles": "package extension (bundles): [amd64]",
    "extension-aarch64-bundles": "package extension (bundles): [arm64]",
