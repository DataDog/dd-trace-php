...
|*                                Socket Stuff                                *|
\******************************************************************************/
// TODO SO_SNDBUF?  what assumptions can we make about the backend?
inline static int SockSetBit(int fd, int bit, bool v) {
...
#define HRES_FUNSDEC(a, b, c, d, e) bool HRESFun_##d(HttpRes *, char *);
...
// Forward decl for header processing functions
