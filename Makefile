...
build_pecl_package:
	{ echo $(subst $(BUILD_DIR)/,,$(C_FILES) $(RUST_FILES) $(TEST_FILES) $(TEST_STUB_FILES) $(M4_FILES) Cargo.lock); find libdatadog/libdd-libunwind-sys/libunwind -type f 2>/dev/null; } | tooling/bin/pecl-build
