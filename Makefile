...
CFLAGS=/nologo $(BASE_INCLUDES) /D _WINDOWS /D WINDOWS=1 /D ZEND_WIN32=1 /D PHP_WIN32=1 /D WIN32 /D _MBCS /D _USE_MATH_DEFINES /FD /wd4996 /Qspectre /guard:cf /Zc:inline /Zc:__cplusplus /d2FuncCache1 /Zc:preprocessor /Zc:wchar_t /MP /LD /MD /Ox /D NDebug /D NDEBUG /GF /D ZEND_DEBUG=0 /D ZTS=1 /I "C:\git\dd-trace-php\no\include" 

LDFLAGS=/nologo /GUARD:CF /d2:-AllowCompatibleILVersions /libpath:"\"C:\git\dd-trace-php\no\lib\"" 
...
$(BUILD_DIR)\\uhook.obj $(BUILD_DIR)\\uhook_attributes.obj $(BUILD_DIR)\\uhook_legacy.obj: C:\git\dd-trace-php\ext\hook\uhook.c C:\git\dd-trace-php\ext\hook\uhook_attributes.c C:\git\dd-trace-php\ext\hook\uhook_legacy.c
	$(CC) $(CFLAGS_DDTRACE_OBJ) $(CFLAGS) /Fo$(BUILD_DIR)\\ $(CFLAGS_BD_) /c C:\git\dd-trace-php\ext\hook\uhook.c C:\git\dd-trace-php\ext\hook\uhook_attributes.c C:\git\dd-trace-php\ext\hook\uhook_legacy.c 
