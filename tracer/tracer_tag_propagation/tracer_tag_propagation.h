...
DATADOG_PUBLIC void ddtrace_add_propagated_tag_on_span_zobj(zend_string *key, zval *value);
...
// Like ddtrace_format_propagated_tags, reading a missing value from `fallback` (nullable).
