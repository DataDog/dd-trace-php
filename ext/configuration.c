...
#else
#define CALIAS(type, name, default, aliases, ...) ZAI_CONFIG_ALIASED_ENTRY(DATADOG_CONFIG_##name, name, type, default, dd_config_aliases_##name, ##__VA_ARGS__),
#endif
zai_config_entry datadog_config_entries[] = {DD_ALL_CONFIGURATIONS};
#undef CALIAS
#undef CONFIG
