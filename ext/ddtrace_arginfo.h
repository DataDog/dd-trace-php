 ...
 * Stub hash: b6f90651aed0d51a55a1701e9fb72d980f4c7c3e */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_DDTrace_set_user, 0, 1, IS_VOID, 0)
	...
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, metadata, IS_ARRAY, 1, "[]")
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_DDTrace_find_active_exception, 0, 0, Exception, 1)
ZEND_END_ARG_INFO()
...
#define arginfo_DDTrace_current_context arginfo_DDTrace_generate_distributed_tracing_headers
...
#define arginfo_dd_trace_serialize_closed_spans arginfo_DDTrace_generate_distributed_tracing_headers
...
static zend_class_entry *register_class_DDTrace_SpanStack(void)
{
	...
	ZVAL_UNDEF(&property_parent_default_value);
	zend_string *property_parent_name = zend_string_init("parent", sizeof("parent") - 1, 1);
	zend_declare_typed_property(class_entry, property_parent_name, &property_parent_default_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_CLASS(property_parent_class_DDTrace_SpanStack, 0, MAY_BE_NULL));
	zend_string_release(property_parent_name);
