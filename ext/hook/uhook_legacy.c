...
static void dd_uhook(INTERNAL_FUNCTION_PARAMETERS, bool tracing, bool method) {
    ...
    zai_string_view class_str = method ? ZAI_STR_FROM_ZSTR(class_name) : ZAI_STR_EMPTY;
    zai_string_view func_str = ZAI_STR_FROM_ZSTR(method_name);
...
PHP_FUNCTION(dd_untrace) {
    ...
    zai_string_view class_str = class_name ? ZAI_STR_FROM_ZSTR(class_name) : ZAI_STR_EMPTY;
    zai_string_view func_str = ZAI_STR_FROM_ZSTR(method_name);
