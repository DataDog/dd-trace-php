 ...
 * Stub hash: 4dbdd47cbb3292807c5d26c923307f051205554b */
...
static const zend_function_entry ext_functions[] = {ZEND_NS_FE("DDTrace", install_hook, arginfo_DDTrace_install_hook)
                                                        ZEND_FE_END};

static const zend_function_entry class_DDTrace_HookData_methods[] = {ZEND_FE_END};
...
static zend_class_entry *register_class_DDTrace_HookData(void) {
    ...
    zend_declare_typed_property(class_entry, property_args_name, &property_args_default_value, ZEND_ACC_PUBLIC, NULL,
    ...
    zend_declare_typed_property(class_entry, property_returned_name, &property_returned_default_value, ZEND_ACC_PUBLIC,
    ...
    zend_declare_typed_property(class_entry, property_exception_name, &property_exception_default_value,
                                ZEND_ACC_PUBLIC, NULL,
                                (zend_type)ZEND_TYPE_INIT_CLASS(property_exception_class_Throwable, 0, MAY_BE_NULL));
    ...
    zend_declare_typed_property(class_entry, property_data_name, &property_data_default_value, ZEND_ACC_PUBLIC, NULL,
