...
zend_result ddtrace_exception_to_meta(zend_object *exception, zend_string *service_name, uint64_t time, ddog_SpanBytes *context, add_tag_fn_t add_meta, enum dd_exception exception_state);
