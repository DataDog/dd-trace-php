        ...
        if (ddtrace_sidecar) {
            ddog_SenderParameters parameters = {
                .tracer_headers_tags = {
                    ...
                    .client_computed_top_level = get_global_DD_TRACE_STATS_COMPUTATION_ENABLED(),
                    .client_computed_stats = get_global_DD_TRACE_STATS_COMPUTATION_ENABLED() || !get_global_DD_APM_TRACING_ENABLED(),
                },
