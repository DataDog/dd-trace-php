...
$asan_build_platforms = [
    [
        "triplet" => "x86_64-unknown-linux-gnu",
        "image_template" => "registry.ddbuild.io/ci/dd-trace-php/dd-trace-ci:php-%s_bookworm-8",
        "arch" => "amd64",
        "host_os" => "linux-gnu",
    ],
    [
...
"pecl build":
  stage: tracing
  image: "registry.ddbuild.io/ci/dd-trace-php/dd-trace-ci:php-7.4_bookworm-8"
  tags: [ "arch:amd64" ]
  needs: [ "prepare code" ]
  script:
...
"pecl tests":
  stage: verify
  image: "registry.ddbuild.io/ci/dd-trace-php/dd-trace-ci:php-${PHP_VERSION}_bookworm-8"
  tags: [ "arch:amd64" ]
  services:
    - !reference [.services, request-replayer]
...
"min install tests":
  stage: verify
  image: registry.ddbuild.io/ci/dd-trace-php/dd-trace-ci:php-8.0-shared-ext-8
  tags: [ "arch:amd64" ]
  variables:
