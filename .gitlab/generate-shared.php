...
"C components ASAN":
  ...
  after_script:
    ...
    - .gitlab/upload-junit-to-datadog.sh "component:shared" "test.type:unit" "test.source.file:components-rs"
  artifacts:
    reports:
...
"Build & Test Tea":
  ...
  after_script:
    ...
    - .gitlab/upload-junit-to-datadog.sh "component:shared" "test.type:unit" "test.source.file:zend_abstract_interface"
  artifacts:
    reports:
      junit: "artifacts/*-results.xml"
    paths:
