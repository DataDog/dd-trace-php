...
|--------|-------|--------------|
| `test appsec extension: [{ver}, {arch}, debug]` | `dd-trace-ci:php-{ver}_bookworm-9` | Builds extension + runs .phpt tests |
| `test appsec helper asan` | `dd-trace-ci:bookworm-9` | C++ helper ASAN gtest suite |
| `appsec code coverage` | `dd-trace-ci:php-8.3_bookworm-9` | (not needed locally) |
